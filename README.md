...
:round_pushpin: 과제 수행 후 결과물 업로드 및 Readme.md에 진행상태에 :white_check_mark: 표기 필수

:round_pushpin: 자유선택 과제는 진행한 과제명과 진행상태에 :white_check_mark: 표기 필수

:round_pushpin: 제출 경로에 본인 학번.zip 또는 학번.확장자 형태로 업로드 필수

:round_pushpin: 제출 {교육생NameSpace} 에 본인 gitlab ID 입력 

### 1일차(예시: 필수선택2, 자유선택38 완료)
...
|`자유선택1`|:white_check_mark:|1. 요구사항 분석|SSAFY 생활|아이디어 기획하기|https://lab.ssafy.com/haeinsuin/self-project/-/tree/master/con04/rep03|---
...
|`필수선택6`|:white_large_square:|2. 설계|분석/설계|코딩 컨벤션 적용|https://lab.ssafy.com/{교육생NameSpace}/self-project/-/tree/master/con12/rep02|
...
|구분|진행상태|단계|분야|과제명|제출 경로|
|----|----|----|----|----|----|
|`필수선택7`|:white_large_square:|3. 개발|네트워크|Java에서 사용하는 통신 인터페이스 실습|https://lab.ssafy.com/{교육생NameSpace}/self-project/-/tree/master/con03/rep02|
...
|`자유선택27`|3. 개발|유니티|포톤 유니티 네트워킹(PUN)를 이용한 멀티플레이 구현|https://lab.ssafy.com/{교육생NameSpace}/self-project/-/tree/master/con18/rep03|
